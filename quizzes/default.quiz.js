let quiz = {
    options: {
        buttons: {
            ...
            agree: {modifier: 1, color: "#09b500", text: "Agree", order: 2},
            somewhat_agree: {
                modifier: .5,
                color: "#88ff75",
                text: "Somewhat Agree",
            ...
            neutral: {modifier: 0, color: "#d9d9d9", text: "Neutral", order: 4},
            somewhat_disagree: {
                modifier: -.5,
                color: "#ff7575",
            ...
            back: {function: "back", color: "gray", text: "Go Back", order: 8}
        },
        axes: [{
            key: "x",
            titles: {negative: "Liberal", positive: "Conservative"},
            colors: {negative: "blue", positive: "red"}
        }, {
            key: "national",
            titles: {negative: "Internationalist", positive: "Nationalist"},
            colors: {negative: "#88ba8d", positive: "#88b8ba"}
        }, {
            key: "authoritarian",
            titles: {negative: "Libertarian", positive: "Authoritarian"},
            colors: {negative: "#ffeb3b", positive: "#3f51b5"}
        }, {
            key: "progressive",
            titles: {negative: "Progressive", positive: "Traditional"},
            colors: {negative: "#888dba", positive: "#a988ba"}
        }, {
            key: "rev",
            titles: {negative: "Revolutionary", positive: "Reformist"},
            colors: {negative: "#c95560", positive: "#55b0c9"}
        }, {
            key: "central",
            titles: {negative: "Centralized", positive: "Decentralized"},
            colors: {negative: "#55c987", positive: "#7ec955"}
        }, {
            key: "production",
            titles: {negative: "Production", positive: "Nature"},
            colors: {negative: "#752112", positive: "#34db16"}
        }, {
            key: "cultural",
            titles: {negative: "Cultural", positive: "Scientific"},
            colors: {negative: "#16dbc4", positive: "#1662db"}
        }, {
            key: "state",
            titles: {negative: "Communal", positive: "Market"},
            colors: {negative: "#9063e6", positive: "#3a1d73"}
        }, {
            key: "religion",
            titles: {negative: "Religious", positive: "Scientific"},
            colors: {negative: "#6a1d73", positive: "#d117c8"}
        }, {
            key: "race",
            titles: {negative: "Identity", positive: "Equality"},
            colors: {negative: "#17d1a3", positive: "#94e0ce"}
        }]
    },
    questions: [{
        ...
        description: "For the same good or service, those with excess money should be required to pay, but those without any money should receive it for free.",
        effect: {
            x: -5,
            national: 0,
            authoritarian: 0,
        ...
        description: "Anyone who holds drastically different political beliefs from me is simply uneducated, and, after receiving education, will realize I'm right.",
        effect: {
            x: 0,
            national: 0,
            authoritarian: 0,
        ...
        question: "Partisan politics are a good thing.",
        ...
        question: "State-church separation is a good idea.",
        ...
        question: "The scientific method is antiquated.",
        ...
        question: "Military is more important than citizen welfare.",
        ...
        question: "Everybody deserves equal opportunity in life.",
        description: "Everybody should be presented with the same opportunities in life. This includes affordable healthcare, welfare programs, affordable colleges, ect.",
        effect: {
            x: -1,
            national: 0,
            authoritarian: -5,
        ...
        description: "My race is better than other races. I should have special privileges over other races because of my skin color.",
        effect: {
            x: 0,
            national: 3,
            authoritarian: 0,
        ...
        description: "There is no chance of a large-scale war starting now. Nuclear weaponry has effectively put everybody in a form of headlock. Nobody dares to break out of it in fear that nuclear weaponry will cripple their nation. There is no chance of another World War.",
        effect: {
            x: 0,
            national: -7,
            authoritarian: 0,
        ...
        description: "All Cops Are Bastards, not meaning all cops are awful people, but rather the police force is used oppressively and should be totally reformed or outright destroyed.",
        effect: {
            x: -4,
            national: 0,
            authoritarian: -3,
        ...
        question: "Primitives is a good idea.",
        ...
        description: "People who can't demonstrate a clear understanding of politics and political philosophy should not be allowed to vote.",
        effect: {
            x: -2,
            national: 0,
            authoritarian: 4,
